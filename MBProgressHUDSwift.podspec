#
#  Be sure to run `pod spec lint MBProgressHUDSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "anchoriteFili" => "feiliyaailiya1@ilcoud.com" }
  # Or just: s.author    = "anchoriteFili"
  # s.authors            = { "anchoriteFili" => "feiliyaailiya1@ilcoud.com" }
  # s.social_media_url   = "http://twitter.com/anchoriteFili"
